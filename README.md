...
```
##### 参考阅读：[闭包_百度百科](https://baike.baidu.com/item/%E9%97%AD%E5%8C%85/10908873?fr=aladdin), [Python 中的闭包 - Python - 伯乐在线](http://python.jobbole.com/82296/), [谈谈自己的理解:python中闭包，闭包的实质 - 稀里糊涂林老冷 - 博客园](https://www.cnblogs.com/Lin-Yi/p/7305364.html)
...
```
##### 参考阅读：[Python super()函数](http://www.runoob.com/python/python-func-super.html), [Python: 你不知道的 super](http://python.jobbole.com/86787/)

### 61、是否使用过functools中的函数？其作用是什么？
```
这个自己也不太清楚，请参考下面的参考阅读。
```
##### [Python标准模块--functools](https://www.cnblogs.com/zhbzz2007/p/6001827.html), [Python-进阶-functools模块小结](http://wklken.me/posts/2013/08/18/python-extra-functools.html)
